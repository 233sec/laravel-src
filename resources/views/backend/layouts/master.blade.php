...
<html class="no-js" lang="">
    ...
    <body class="skin-{{ config('backend.theme') }} {{ config('backend.layout') }} sidebar-mini">
        ...
        <script type="text/javascript">
                            ...
                            if (contents.id == "Upload") {
                                window._rf = setInterval(function() {
                                    if($('iframe.cke_dialog_ui_input_file').length){
                                        ...
                                        .parent()
                                            .attr('action', '{{ URL::route("admin.institutionmanage_upload_institution_file", ["wysiwyg"=>1]) }}')
            ...
            window.file_upload_url = '{{ URL::route("admin.institutionmanage_upload_institution_file") }}';
            ...
            $('input[type="file"]').uploader({
                url: '{{ URL::route("admin.institutionmanage_upload_institution_file") }}',
